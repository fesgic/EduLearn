...
#  Feb 19, 2020 08:30:19 PM EAT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    wm geometry $top 600x450+361+155
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $top.but45 \
        -activebackground #4096ed -background $vTcl(actual_gui_bg) \
    ...
    ###################
    place $top.lab44 \
        -in $top -x 0 -relx 0.117 -y 0 -rely 0.022 -width 0 -relwidth 0.807 \
        -height 0 -relheight 0.313 -anchor nw -bordermode ignore 
    place $top.but45 \
        -in $top -x 0 -relx 0.8 -y 0 -rely 0.867 -width 85 -relwidth 0 \
